            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                        ...
                        <input type="text" v-validate="'required'" class="control" id="title" name="title" value="{{ old('title') ?? ($notificationTranslation['title'] ?? '') }}" data-vv-as="&quot;{{ __('mobikul::app.mobikul.notification.notification-title') }}&quot;" v-slugify-target="'slug'"/>
                    ...
                    <div class="control-group" :class="[errors.has('content') ? 'has-error' : '']">
                        ...
                        <textarea class="control" name="content" v-validate="'required'" data-vv-as="&quot;{{ __('mobikul::app.mobikul.notification.notification-content') }}&quot;" cols="30" rows="10">{{ old('content') ?? $notificationTranslation['content'] }}
                        </textarea>
