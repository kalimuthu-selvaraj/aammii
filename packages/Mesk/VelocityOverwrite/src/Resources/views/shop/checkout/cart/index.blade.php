...
@push('css')
    <style type="text/css">
		...
		.remove-btn span.rango-delete {
			color:#fff !important;
			font-size:22px !important;
		}
		.remove-btn span.align-vertical-super { 
				color:#fff !important;
...
@push('scripts')
    ...
    <script type="text/x-template" id="cart-template">
        <div class="">
            <section class="cart-details row no-margin col-12 checkout-padding theme-bg">
                <h2 class="fw6 fs24 col-12">{{ __('shop::app.checkout.cart.title') }} <img loading="lazy" alt="wave" src="{{ asset('/themes/velocity/assets/images/wave-1.png') }}"></h2>

                @if ($cart)
                    <div class="cart-details-header col-lg-7 col-md-12">
                        <div class="row cart-header col-12 no-padding">
                            <span class="col-8 fs18 checkout-color pr0">
                                {{ __('velocity::app.checkout.items') }}
                            </span>

                            <span class="col-2 fs18 checkout-color no-padding text-right">
                                {{ __('velocity::app.checkout.qty') }}
                            </span>

                            <span class="col-2 fs18 checkout-color text-right pr80">
                        ...
                        <div class="cart-content col-12">
                            <form
                                    ...
                                    @foreach ($cart->items as $key => $item)
                                        ...
                                        <div class="row col-12" v-if="!isMobileDevice">
                                            ...
                                            <div class="product-details-content col-6 pr0">
                                                <div class="row item-title no-margin">
                                                    <a
                                                        ...
                                                        <span class="fs20 link-color">{{ $product->name }}</span>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="row col-12 no-padding no-margin">
                                                    <div class="product-price">
                                                        <span class="price-normal theme-color">{{ core()->currency($item->base_price) }}</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="product-price fs18 col-1">
                                                <span class="card-current-price fw6 mr10 ml-25">
                                ...
                                {!! view_render_event('bagisto.shop.checkout.cart.controls.after', ['cart' => $cart]) !!}
                                    <a
                                        class="col-12 link-color-shop remove-decoration fs16 no-padding"
                                    ...
                                    <button
                                        type="submit"
                                        class="theme-btn light mr15 float-right unset update-cart-shop">
                ...
                {!! view_render_event('bagisto.shop.checkout.cart.summary.after', ['cart' => $cart]) !!}
                    ...
                    @if ($cart)
                        <div class="col-lg-5 col-md-12 offset-lg-0 row order-summary-container">
