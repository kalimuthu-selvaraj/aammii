...
<header class="sticky-header">
    <div class="row remove-padding-margin velocity-divide-page">
        ...
        <div class="right searchbar">
            <div class="row">
				...
				<div class="col-lg-4 col-md-12 vc-full-screen guest-design">
                ...
                <div class="col-lg-3 col-md-12 vc-full-screen">
                    <div class="left-wrapper">
                        ...
                        {!! view_render_event('bagisto.shop.layout.header.compare.after') !!}
 						...
 						<a class="compare-btn unset" :href="`${$root.baseUrl}/page/events`">
    ...
    <div class="col-md-10 ml-220">
    @include('shop::layouts.header.meskdesktop')
    </div>
</header>
