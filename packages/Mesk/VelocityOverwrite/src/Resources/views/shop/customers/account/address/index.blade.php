...
@section('page-detail-wrapper')
    ...
    <div class="account-head">
        ...
        <span class="account-heading">{{ __('shop::app.customer.account.address.index.title') }} <img loading="lazy" alt="wave" src="{{ asset('/themes/velocity/assets/images/wave-1.png') }}"></span>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a class="card-link edit-bg" href="{{ route('customer.address.edit', $address->id) }}">
                                        <i class="material-icons ">edit</i> {{__('shop::app.customer.account.address.index.edit') }}
                                    </a>

                                    <a class="card-link delete-bg" href="javascript:void(0);" onclick="deleteAddress('{{ __('shop::app.customer.account.address.index.confirm-delete') }}')">
