    ...
    <div class="auth-content form-container">
        <div class="container">
            <div class="col-lg-10 col-md-12 offset-lg-1">
                <div class="heading">
                    <h2 class="fs24 fw6">
                        {{ __('velocity::app.customer.forget-password.forgot-password')}} <img loading="lazy" alt="wave" src="{{ asset('/themes/velocity/assets/images/wave-1.png') }}">
                    </h2>
                ...
                <div class="body col-12 forgot-input">
					...
					<p class="fs16 text-center mb-20">
                    ...
                    <form
                        ...
                        <button class="theme-btn btn-width forgot-btn" type="submit">
