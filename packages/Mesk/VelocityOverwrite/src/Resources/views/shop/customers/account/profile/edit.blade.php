...
@section('page-detail-wrapper')
    <div class="account-head mb-15">
        ...
        <span class="account-heading">{{ __('shop::app.customer.account.profile.index.title') }} <img loading="lazy" alt="wave" src="{{ asset('/themes/velocity/assets/images/wave-1.png') }}"></span>
        <span></span>
    </div>
    ...
    <form
        ...
        <div class="account-table-content theme-button">
            ...
            <div class="row">
                ...
                <div :class="`col-10 ${errors.has('oldpassword') ? 'has-error' : ''}`">
