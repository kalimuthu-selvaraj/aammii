...
@section('page-detail-wrapper')
    <div class="account-head mb-15">
        ...
        <span class="account-heading">{{ __('shop::app.customer.account.address.edit.title') }} <img loading="lazy" alt="wave" src="{{ asset('/themes/velocity/assets/images/wave-1.png') }}"></span>
        <span></span>
    </div>
        ...
        <div class="account-table-content row">
            ...
            @if (core()->getConfigData('customer.settings.address.street_lines') && core()->getConfigData('customer.settings.address.street_lines') > 1)
                @for ($i = 1; $i < core()->getConfigData('customer.settings.address.street_lines'); $i++)
                    <div class="control-group col-10" style="margin-top: -25px;">
