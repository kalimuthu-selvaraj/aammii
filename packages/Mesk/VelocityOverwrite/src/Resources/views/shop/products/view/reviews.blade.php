    ...
    @if ($total)
        @if (isset($accordian) && $accordian)
            <accordian :active="true">
                ...
                <div class="row customer-rating mt-30" slot="body">
                    <div class="row full-width text-center mb30">
                        <div class="col-lg-6 col-xl-4 theme-icon-color">
                            <h4 class="col-lg-12 fs16 star-points">{{ $avgRatings }}</h4>
                            ...
                            <span class="fs13 display-block theme-gray">
                        ...
                        <div class="col-lg-12 col-xl-6">
                            ...
                            @for ($i = 5; $i >= 1; $i--)
                                ...
                                <div class="row">
                                    <span class="col-3 no-padding fs16 fw6 theme-gray">{{ $i }}</span>
        ...
        @else
            <div class="row customer-rating theme-icon-color">
                <div class="row full-width text-center mb30">
                    <div class="col-lg-12 col-xl-6">
                ...
                <div class="customer-reviews" slot="body">
                    @foreach ($reviews as $review)
                        <div class="row review-border">
                            <h4 class="col-lg-12 fs18 cart-title-color">{{ $review->title }}</h4>

                            <star-ratings
                                :ratings="{{ $review->rating }}"
                                push-class="mr10 fs16 col-lg-12 theme-icon-color ptb"
                            ></star-ratings>
                            ...
                            <div class="col-lg-12 mt5 pt-25">
                                <span class="fs16 fw5 review-color">{{ __('velocity::app.products.review-by') }} -</span>

                                <span class="fs16 fw5 review-color">
                                    {{ $review->name }},
                                </span>

                                <span class="review-date">{{ core()->formatDate($review->created_at, 'F d, Y') }}
                                </span>
                            </div>
                        </div>
                    @endforeach
					<div class="text-center review-view-btn">
                    <a
                        href="{{ route('shop.reviews.index', ['slug' => $product->url_key ]) }}"
                        class="mb20 link-color view-button"
            ...
            <div class="customer-reviews">
                @foreach ($reviews as $review)
                    <div class="row">
                        ...
                        <star-ratings
                            :ratings="{{ $review->rating }}"
                            push-class="mr10 fs16 col-lg-12 theme-icon-color"
                        ></star-ratings>
