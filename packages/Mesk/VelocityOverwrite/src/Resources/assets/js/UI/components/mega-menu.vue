    ...
    <nav
        ...
        <ul type="none">
            <li
                ...
                @mouseout="toggleMegamenu(id, $event, 'mouseout')"
                @mouseover="toggleMegamenu(id, $event, 'mouseover')"
                            ...
                            <ul type="none">
                                <li class="menu-title-width"
                                    ...
                                    <a
                                        ...
                                        :class="`category sub-category cursor-pointer unset ${(subCategory.children.length > 0) ? 'fw6' : ''}`">
                                        ...
                                        <span class="category-title">{{ subCategory['name'] }} 
                                        <img loading="lazy" alt="wave" :src="`${$root.baseUrl}/themes/velocity/assets/images/menu-wave.png`"></span>
                                    </a>
