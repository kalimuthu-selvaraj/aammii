<template>
    ...
    <div class="card grid-card product-card-new" v-else>
        ...
        <div class="card-body home-page">
            ...
            <div class="product-price fs16 price-align" v-html="product.priceHTML"></div>

            <div
                class="product-rating col-12 no-padding price-rating-align"
                ...
                <a class="fs14 align-top unset active-hover" :href="`${$root.baseUrl}/reviews/${product.slug}`">
                    <i class="material-icons star-icon-ratings">star</i> {{ product.totalReviews }}
                </a>
            </div>

            <div class="product-rating col-12 no-padding" v-else>
                <span class="fs14 display-none" v-text="product.firstReviewText"></span>
            </div>
