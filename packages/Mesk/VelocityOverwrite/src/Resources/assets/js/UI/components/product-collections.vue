        ...
        <template v-else-if="productCollections.length > 0">
            ...
            <div class="row" :class="localeDirection">
                <div
                    ...
                    :class="showRecentlyViewed === 'true' ? 'col-lg-12' : 'without-recent-viewed col-lg-12'">
                    <carousel-component
                ...
                <recently-viewed
                    ...
                    :add-class="`col-lg-3 col-md-12 display-none ${localeDirection}`"
                    quantity="3"
                    add-class-wrapper=""
                    v-if="showRecentlyViewed === 'false'">
                </recently-viewed>
            </div>
        </template>
    </div>
