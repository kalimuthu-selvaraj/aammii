    ...
    <div :class="`dropdown ${cartItems.length > 0 ? '' : 'disable-active'}`">
        ...
        >
                ...
                >
                    ...
                    <div class="col-9 no-padding card-body align-vertical-top">
                        <div class="no-padding">
                            <div
                                class="fs16 text-nowrap text-black"
                                v-html="item.name"
                            ></div>
            ...
            <div class="modal-footer">
                <h5 class="col-6 text-left fw6 no-padding">
                    {{ subtotalText }}
                </h5>
            ...
            <div class="modal-footer">
                <a
                    class="col text-left fs16 remove-decoration social-icons"
                    :href="viewCartRoute"
                    >{{ viewCartText }}</a
                >
                ...
                <div class="col text-right no-padding">
                    <a :href="checkoutRoute" @click="checkMinimumOrder($event)">
                        <button type="button" class="theme-btn fs16 fw6 border-checkout">
                            {{ checkoutText }} <i class="arrow-right text-white"></i>
                        </button>
                    </a>
                </div>
            </div>
