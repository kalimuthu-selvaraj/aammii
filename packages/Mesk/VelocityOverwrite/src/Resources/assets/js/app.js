...
Vue.component('mega-menu-component', require('./UI/components/mega-menu'));
...
$(function() {
    ...
    Vue.mixin({
        ...
        methods: {
            ...
            debounceToggleMegamenu: function(id, { target }, type) {
                this.toggleMegamenu(id, target, type);
            },

            toggleMegamenu: function(id, { target }, type) {
                if (
                    Array.from(target.classList)[0] == 'main-category' ||
                    Array.from(target.parentElement.classList)[0] ==
                        'main-category'
...
\                                this.hide(subCategories1);
            ...
            show: function(element) {
                ...
                element.mouseleave(({ target }) => {
                    ...
                    $(target.closest('.sidebar')).parent('.sub-categories').hide();
                });
            },
