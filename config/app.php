...
return [
    ...
    */
    ...
    'providers' => [
        ...
        // Razorpay provider
        Mesk\razorpay\Providers\RazorpayServiceProvider::class,

        // Overwrite Velocity css and blade files
        Mesk\VelocityOverwrite\Providers\VelocityOverwriteServiceProvider::class,

        // Packages for inventory bulk update
        Mesk\InventoryBulkUpdate\Providers\InventoryBulkUpdateServiceProvider::class,
        Webkul\TableRate\Providers\TableRateServiceProvider::class,

        //Package for Mobilekul
